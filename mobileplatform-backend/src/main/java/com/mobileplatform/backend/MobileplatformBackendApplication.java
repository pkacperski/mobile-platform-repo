...
public class MobileplatformBackendApplication {
	...
	public final static boolean IS_SAVING_VIDEOS = false; // TODO - set to 'true' to save all video data coming from vehicles on hard disk; to 'false' not to save video data
